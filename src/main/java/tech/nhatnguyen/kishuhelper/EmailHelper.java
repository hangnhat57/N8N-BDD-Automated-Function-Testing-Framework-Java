package tech.nhatnguyen.kishuhelper;
...
import static tech.nhatnguyen.shibahelper.SystemConfiguration.Env;

public class EmailHelper {
    private static final String USER_PROTOCOL = Env("MAIL_PROTOCOL");
    private static final String USER_HOST = Env("MAIL_HOST");
    private static final String USER_EMAIL = Env("MAIL_EMAIL");
    private static final String USER_PASSWORD = Env("MAIL_PASSWORD");
